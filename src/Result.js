...
const Result = ({width,height,length,measure,meter,lt0m,ht0m,wt0m,cmt0m,mt0cm}) => {
  return (
    <div class="col-md-4 result">
    <div class="card ">
    <div class="card-body">
    <h5 class="text-center py-3"> RESULT</h5>
    <div class="result-div"> <span id="length_val"> {length} </span> * <span id="width-val">{width}</span> * <span id="height-val">{height}</span> <span id="unit_val">{measure}</span> = <span id="result_in_m" class="fw-bold">{mt0cm}</span> <span class="fw-bold">m<sup>3</sup></span> = <span id="result_in_f" class="fw-bold"></span> <span class="fw-bold"> ft<sup>3</sup></span> </div>
    <div class="py-3">
